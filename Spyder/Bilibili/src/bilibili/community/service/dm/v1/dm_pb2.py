...
# source: community/service/dm/v1/dm.proto
...
BuzzwordConfig = _reflection.GeneratedProtocolMessageType('BuzzwordConfig', (_message.Message,), {
  ...
  '__module__' : 'community.service.dm.v1.dm_pb2'
